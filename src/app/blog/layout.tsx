      ...
      <section id="blog-content" className="mx-auto grid w-full max-w-5xl gap-10 px-6 py-12 lg:grid-cols-[2fr_1fr]">
        ...
        <aside className="space-y-8" aria-label="Blog sidebar">
          <section id="blog-search" className="rounded-2xl border bg-white p-5 shadow-sm">
            ...
            <div className="relative mt-4">
              ...
              <input
                type="text"
                placeholder="search..."
                className="h-11 w-full rounded-md border border-input bg-background px-10 text-sm text-black outline-none transition focus:border-primary"
              />
            </div>
          </section>
          ...
          <section id="blog-recent" className="rounded-2xl border bg-white p-5 shadow-sm">
            <h2 className="text-lg font-semibold text-black">Recent Posts</h2>
          ...
          <section id="blog-tags" className="rounded-2xl border bg-white p-5 shadow-sm">
            <h2 className="text-lg font-semibold text-black">Popular Tags</h2>
            <div className="mt-4 flex flex-wrap gap-2">
              {popularTags.map((tag) => (
                <span
                  key={tag}
                  className="rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-black"
                >
                  {tag}
                </span>
              ))}
